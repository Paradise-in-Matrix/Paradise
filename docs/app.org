...
@media (max-width: 768px) {
    .app-root {
        position: relative;
        overflow: hidden;
        padding-top: env(safe-area-insert-top, 0px);
        padding-bottom: env(safe-area-insert-bottom, 0px);
    }
    ...
    .sidebar-rooms {
        position: absolute;
        z-index: 100;
        top: env(safe-area-insert-top, 0px);
        bottom: env(safe-area-insert-bottom, 0px);
