...
Handling functionality related to the composer.
May need some love and attention as... File uploads
occur in more places than just the composer haha.

***** TODO Move File upload and non-specific to composer parts out

**** Imports

#+begin_src clojurescript :tangle ../../../src/paradise/engine/composer.cljs
