...
This is where we handle effectively everything for Matrix rooms.

**** Imports


#+begin_src clojurescript :tangle ../../../src/paradise/engine/rooms.cljs
...
For room creation we may need to take a peek at the FFI bindings to expose room
type as a parameter. For now this at least provides the core functionality.
