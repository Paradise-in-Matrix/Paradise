...
#+begin_src clojurescript :tangle ../../../../src/paradise/ui/input/drafts.cljs
...
**** Massive Blob of Reframe Events
 ...
 Currently Eve is breaking this because attachments are in the app-db
 Eve and attachments both are SAB objects and I'm not sure
 Eve knows how to handle other ones
 Will probably pull attachments out and send the URI which references
 the SAB attachment instead
