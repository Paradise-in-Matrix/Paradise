...
** Matrix Stream Bindings

**** Preface

A set of bindings for testing our Matrix stream bindings.
Could probably be relocated later.


**** Dump

#+begin_src clojurescript :tangle ../../../src/paradise/binding/matrix.cljs
