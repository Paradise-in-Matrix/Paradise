...
In advance, apologies for this monstrosity. Rushing a bit to get these done so I'm just writing them out and moving
on. I do plan to come back and break these bits apart better.


***** Component

****** TODO Swap out the icons with SVGs
#+begin_src clojurescript :tangle ../../src/overlays/lightbox.cljs
(defn image-lightbox []
