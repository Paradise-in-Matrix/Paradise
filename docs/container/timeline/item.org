...
#+begin_src clojurescript :tangle ../../../src/container/timeline/item.cljs
(defn ^:ui event-menu [mx my current-item active-room my-id]
  (re-frame/dispatch
        ...
        [:div.message-hover-toolbar
         ...
         (when (:is-own? item)
           [:div.toolbar-btn
            {:title edit-str
             :on-click #(re-frame/dispatch
                         [:input/set-context active-room :edit item])}
            [icons/edit]])
         [:div.toolbar-btn
          {:title more-str
           :on-click (fn [e]
...
Could be a bit more generic given the insight gleamed
working on deferred rendered components.
...
#+begin_src clojurescript :tangle ../../../src/container/timeline/item.cljs
(defn ^:ui render-message-content [tr msg-type-tag content-map in-reply-to reply-msg event]
...
(defn event-menu [mx my current-item active-room my-id]
  (re-frame/dispatch
   [:ui/open-context-menu :message-actions
    {:x mx :y my :item current-item :active-room active-room :my-id my-id}]))
