...
#+begin_src clojurescript :tangle ../../src/plugin_build.clj
(ns plugin-build
  (:require
...
Might've been a cleaner way to do this, but I'm wanting to get this wrapped
up and move on to other parts of Paradise. So we just sort of jam the defer
binding in for the parser to see later in the virtualizer if it has that
tag.

May be worth looking into seeing what we can re-use in the lambda lifter
later and making a more streamlined implementation. These are more of
bludgeoning devices...

#+begin_src clojurescript :tangle ../../src/build_hooks/plugin_build.cljs
