             ...
             (if (seq? x)
               (cond
                 ...
                 (let [ns-name (second x)
                       reqs (if (#{'paradise.shared.client.registry 'paradie.shared.client.state 're-frame.db 'paradise.shared.client.core 'paradise.shared.utils.macros} ns-name)
                 ...
                 (let [fn-name      (second x)
                       ...
                       registry     (if (or is-ui? is-react?) 'paradise.shared.client.registry/!components 'paradise.shared.client.registry/!pure-fns)
...
#+begin_src clojurescript :tangle ../../hooks/lambda_lifter.clj
(defn skip-file? [code]
  (re-find #"\(ns\s+(paradise\.shared\.utils\.macros|paradise\.shared\.client\.registry|paradise\.shared\.client\.state|paradise\.shared\.client\.core|re-frame\.db|net)" code))
#+end_src
