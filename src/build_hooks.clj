...
(defn copy-wasm
  ...
  [build-state & args]
  (let [source (io/file "packages/generated-compat/src/generated-compat/wasm-bindgen/index_bg.wasm")
        target (io/file "build/generated-compat/wasm-bindgen/index_bg.wasm")]
    (when (.exists source)
